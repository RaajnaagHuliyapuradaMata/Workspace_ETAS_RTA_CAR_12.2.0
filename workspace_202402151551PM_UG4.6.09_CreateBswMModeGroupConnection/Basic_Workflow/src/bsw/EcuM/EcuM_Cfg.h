...
#define ECUM_IGNORE_WAKEUPEVVAL_OFFPREOS  (STD_OFF) 
...
typedef struct
{
    uint8 nbrOfComChannelPresent;            /*uint8 variable to specify the number of Com Channel references*/                      
    const uint8 * ComChannelReferance;       /*uint8 pointer to specify the array of Com Channel references*/
...
typedef enum  {
  ...
  /* ECUM_END_CHECK_WAKEUP_E = 3, Respective api has been removed */
