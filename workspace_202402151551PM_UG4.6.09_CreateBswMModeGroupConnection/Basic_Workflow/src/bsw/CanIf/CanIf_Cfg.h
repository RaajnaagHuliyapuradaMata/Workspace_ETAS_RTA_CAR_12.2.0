...
/* Range       :  STD_ON/STD_OFF                                                  */
/**************************************************************************/
#define CANIF_VERSIONINFO_API                     STD_OFF
/**************************************************************************/
...
/******************************************************************************
** Description :  Enables/Disables Time Stamp feature                       **
** Range       :  STD_ON/STD_OFF                                             **
******************************************************************************/
...
#define CANIF_FD_SUPPORT                       STD_ON
...
/* Enable/Disable XCP Support */
#define CANIF_RBA_J1939FDTP_ENABLED                       STD_OFF
...
#define CanIfConf_CanIfTxPduCfg_ApplicationECU_To_TestECU_Can_Network_CANNODE_0_OUT        0
...
#define CanIfConf_CanIfRxPduCfg_TestECU_To_ApplicationECU_Can_Network_CANNODE_0_IN        0
...
/* CanIf callback names for 3rd party driver interaction (the Autosar based API names will be declared in integration code) */
#define CANIF_RXINDICATION_FNAME                   CanIf_Integn_RxIndication
#define CANIF_TRCVMODEINDICATION_FNAME             CanIf_Integn_TrcvModeIndication
#define CANIF_CLEARTRCVWUFFLAGINDICATION_FNAME     CanIf_Integn_ClearTrcvWufFlagIndication
#define CANIF_CHECKTRCVWAKEFLAGINDICATION_FNAME    CanIf_Integn_CheckTrcvWakeFlagIndication
#define CANIF_CONFIRMPNAVAILABILITY_FNAME          CanIf_Integn_ConfirmPnAvailability
#define CANIF_TXCONFIRMATION_FNAME                 CanIf_Integn_TxConfirmation
#define CANIF_TRIGGERTRANSMIT_FNAME                CanIf_Integn_TriggerTransmit
#define CANIF_CONTROLLERBUSOFF_FNAME               CanIf_Integn_ControllerBusOff
#define CANIF_CONTROLLERMODEINDICATION_FNAME       CanIf_Integn_ControllerModeIndication
#define CANIF_CONTROLLERERRORPASSIVE_FNAME         CanIf_Integn_ControllerErrorPassive

#define THIRD_PARTY_DRIVER_INTEGRATION		       (STD_ON)
#define THIRD_PARTY_CANTRCV_DRIVER_INTEGRATION     (STD_OFF)
...
typedef struct
{
    ...
    void (*User_ControllerModeIndication) (uint8 ControllerId, Can_ControllerStateType ControllerMode);
...
typedef struct
{
    ...
    * Basic List: Gives mapping index to the List structure */
    ...
    #if ((CANIF_RB_CHANGERXPDUID_API != STD_OFF)||(CANIF_GLOBAL_TIME_SUPPORT != STD_OFF))
...
typedef struct
{
     ...
     * 8            rba_J1939FdTp_RxIndication
     * 9            Cdd1 (from 9 CDD function starts)
     * 10            Cdd2
     * 11           USER1(Index for USER starts after CDD indexing is completed)
     * 12           USER2*/
...
typedef struct{
    ...
    Std_ReturnType (*SetCrtlMode) (uint8, Can_ControllerStateType);
    
    #if(CANIF_CFG_TX_FEATURE_ENABLED== STD_ON)
    /*Function pointer to CanWrite API */
    Std_ReturnType (*CanWrite) (Can_HwHandleType, const Can_PduType*);
    #endif
    
    #if (CANIF_LITE_CONFIGURATION == STD_OFF)   
    /*Function pointer to GetControllerMode API */
    Std_ReturnType (*GetControllerMode) (uint8, Can_ControllerStateType*);
    #endif
  
    /*Function pointer to GetCurrentTime API */
    Std_ReturnType (*GetCurrentTime) (uint8, Can_TimeStampType*);
    
    /*Function pointer to EnableEgressTimeStamp API */
    void (*EnableEgressTimeStamp) (Can_HwHandleType);
    
    /*Function pointer to GetEgressTimeStamp API */
    Std_ReturnType (*GetEgressTimeStamp) (PduIdType, Can_HwHandleType, Can_TimeStampType*);
    
    /*Function pointer to GetIngressTimeStamp API */
    Std_ReturnType (*GetIngressTimeStamp) (Can_HwHandleType, Can_TimeStampType*);
 ...
 *   void (*UserTxConfirmation) (PduIdType TxPduTargetPduId, Std_ReturnType result);
...
typedef struct
{
    ...
    #endif
    const CanIf_Cfg_CtrlConfig_tst       *CanIf_CtrlConfigPtr;
    const CanIf_Cfg_TrcvConfig_tst       *CanIf_TrcvConfigPtr;
    uint32                            NumOfTxPdus;
