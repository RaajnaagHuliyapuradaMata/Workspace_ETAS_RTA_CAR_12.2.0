...
#define COMM_E_MULTIPLE_PNC_ASSIGNED                3

#define COMM_E_NO_PNC_ASSIGNED                      4

#define COMM_E_NOT_INITIALIZED                      5
 ...
 *  @return None                                        \n
 */
/* MR12 RULE 8.6 VIOLATION: The warning is not critical and has no functional impact.
 * The function definition is available when COMM_VERSION_INFO_API is STD_ON and this macro is available
 * in private header file. The warning is considered as LOW_PRIO */
 ...
 *                   COMM_E_NO_PNC_ASSIGNED: Function could not provide the current mode of the PNC,
 ...
 * also generated by the RTE if it is configured. These APIs are accessible by BSW component(BswM). If the declaration
 * is not provided by ComM.h then build would fail */
extern Std_ReturnType ComM_GetCurrentPNCComMode(ComM_UserHandleType User, ComM_ModeType * ComMode);
#endif /* COMM_RTE_GENERATED_APIS */
/**
 * @ingroup COMM_H
 *
 ...
 */
#ifndef COMM_RTE_GENERATED_APIS
/* MR12 RULE 8.5, 8.6 VIOLATION: Multiple declarations of external object or function. The function declaration is
 * also generated by the RTE if it is configured. These APIs are accessible by BSW component(BswM). If the declaration
 * is not provided by ComM.h then build would fail */
