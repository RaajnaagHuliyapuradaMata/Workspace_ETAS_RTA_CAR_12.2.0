...
LOCAL_INLINE void SchM_Enter_ComM_User(void);
LOCAL_INLINE void SchM_Exit_ComM_User(void);
...
LOCAL_INLINE void SchM_Enter_ComM_PNC(void);
LOCAL_INLINE void SchM_Exit_ComM_PNC(void);
...
LOCAL_INLINE void SchM_Enter_ComM_Limitation(void);
LOCAL_INLINE void SchM_Exit_ComM_Limitation(void);
