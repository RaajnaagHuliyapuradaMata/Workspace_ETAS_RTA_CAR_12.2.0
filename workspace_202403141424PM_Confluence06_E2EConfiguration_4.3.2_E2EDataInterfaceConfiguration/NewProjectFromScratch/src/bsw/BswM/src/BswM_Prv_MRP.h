...
boolean BswM_Prv_GetNmWkupIndERPIndex_b( uint8 idChannel_u8, uint16 * idx_pu16);
...
boolean BswM_Prv_GetNmStateChngMRPIndex_b(NetworkHandleType idNetwork_u8,  uint16 * idx_pu16);
...
boolean BswM_Prv_GetSoAdSoConModeChgMRPIndex_b (SoAd_SoConIdType idConGrp_u16, uint16 * idx_pu16);
