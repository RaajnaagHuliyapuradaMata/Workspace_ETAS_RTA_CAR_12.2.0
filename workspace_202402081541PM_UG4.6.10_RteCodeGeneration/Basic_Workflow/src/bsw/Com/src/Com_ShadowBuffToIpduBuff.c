...
# endif /* #ifdef COM_TX_DYNAMIC_GROUPSIGNAL_SUPPORT */
        {
            ...
            switch (sigType_u16 >> 1u)
            {
                ...
                {
                    txGrpSigNewVal_uo = COM_GET_TXGRPSIGTYPEU8_BUFF(idTxMainFunc_uo,
                                                                           txGrpSigConstPtr_pcst->idxTxGrpSigBuff_uo);
                }
                break;
                case 0x01u:
                {
                    /* UINT16 signal */
                    txGrpSigNewVal_uo = COM_GET_TXGRPSIGTYPEU16_BUFF(idTxMainFunc_uo,
                                                                           txGrpSigConstPtr_pcst->idxTxGrpSigBuff_uo);
                }
                break;
...
# endif
                ...
                {
                    txGrpSigNewVal_uo = COM_GET_TXGRPSIGTYPEU32_BUFF(idTxMainFunc_uo,
                                                                        txGrpSigConstPtr_pcst->idxTxGrpSigBuff_uo);
                }
                break;
...
# ifdef COM_TXGRPSIG_INT64
                ...
                {
                    /* UINT64 signal */
                    txGrpSigNewVal_uo = COM_GET_TXGRPSIGTYPEU64_BUFF(idTxMainFunc_uo,
                                                                        txGrpSigConstPtr_pcst->idxTxGrpSigBuff_uo);
                }
                break;
