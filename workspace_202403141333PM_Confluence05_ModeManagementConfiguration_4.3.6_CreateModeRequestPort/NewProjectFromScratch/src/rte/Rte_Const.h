...
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_BswM                             SWCI4
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_ComM                             CPT_ComM
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_EcuM                             SWCI5
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_MyReceivingSWC_ApplicationEcu    CPT_MyReceivingSWC_ApplicationEcu
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_MyTransmittingSWC_ApplicationEcu CPT_MyTransmittingSWC_ApplicationEcu
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_NvM                              SWCI6
#define ApplicationECU_FlatView_SwComponentTypes_ApplicationECU_FlatView_CPT_rba_DiagLib                      SWCI3
