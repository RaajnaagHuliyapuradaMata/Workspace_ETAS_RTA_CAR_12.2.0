...
#if !defined(RTE_LOCAL)									  /* [$Satisfies $rte_misra 001] */
#define RTE_LOCAL static
#endif /* !defined(RTE_LOCAL) */
...
/* [$Satisfies $rte_misc 263] */
#define RTE_E_RAM_UNCHANGED    ((Std_ReturnType)142u)
...
#else
#define RTE_ALARMREFTYPE              uint16
#endif
#endif
