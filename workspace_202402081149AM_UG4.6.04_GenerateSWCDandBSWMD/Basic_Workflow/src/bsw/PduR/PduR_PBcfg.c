...
static const PduR_RT_UpToLo PduR_comToLo [] = {
    { CanIfConf_CanIfTxPduCfg_ApplicationECU_To_TestECU_Can_Network_CANNODE_0_OUT , (PduR_loTransmitFP)PduR_RF_CanIf_Transmit, (PduR_loCancelTransmitFP)PduR_IH_CancelTransmit }    /*ApplicationECU_To_TestECU_Com2PduR_Can_Network_Channel_CAN*/
...
{ 
    ...
    /*ApplicationECU_To_TestECU_Com2CanIf_Can_Network_Channel_CAN 0 */
    0         
};  
...
static const PduR_RT_LoIfRxToUp PduR_CanIfRxToUp[] = {        
    { ComConf_ComIPdu_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx, (PduR_upIfRxIndicationFP) PduR_RF_Com_RxIndication }    /*TestECU_To_ApplicationECU_CanIf2PduR_Can_Network_Channel_CAN*/
 };
...
{ 
    ...
    /*TestECU_To_ApplicationECU_CanIf2Com_Can_Network_Channel_CAN 0 */
    0         
};
...
{ ComConf_ComIPdu_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx , (PduR_upIfTxConfirmationFP) PduR_RF_Com_TxConfirmation}     /* Index: 0  SrcPdu: ApplicationECU_To_TestECU_Com2PduR_Can_Network_Channel_CAN  DestPdu: ApplicationECU_To_TestECU_PduR2CanIf_Can_Network_Channel_CAN*/
};
...
{  
    ...
    /*ApplicationECU_To_TestECU_PduR2CanIf_Can_Network_Channel_CAN 0 */
    0        
}; 
