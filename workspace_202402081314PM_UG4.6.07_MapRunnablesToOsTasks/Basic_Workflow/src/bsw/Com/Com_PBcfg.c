...
const Com_Prv_xTxSigCfg_tst Com_Prv_xTxSigCfg_acst[COM_NUM_TX_SIGNALS] =
{
    ...
    {  /* S_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx */
        &Com_Prv_TxSigFlagS_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx_st,
#ifdef COM_TxInvalid
        0uL,        /* DataInvalid_Val*/
#endif
        ...
        0u, /* Handle Id: ComConf_ComSignal_S_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx */
        ...
        */
        ...
        (Com_IpduId_tuo)ComIPdu_Internal_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx,             /*Ipdu Reference*/
...
{    
    ...
    {  /* S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx */
        ...
        &Rte_COMCbk_S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx,
#endif
#ifdef COM_RxSigInvalidNotify
        /* Com Invalid Notification */
        NULL_PTR,
#endif
        &Com_Prv_RxSigFlagS_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx_st,
#ifdef COM_RxSigInvalid
       0uL,              /* DataInvalid_Val */
#endif

        0u, /* Handle Id: ComConf_ComSignal_S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx */
      ...
      8, /*BitSize*/
       ...
       (Com_IpduId_tuo)ComIPdu_Internal_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx,                       /*Ipdu Reference*/
...
const Com_RxSigConfigType_tst Com_Prv_RxSigCfg_acst[COM_NUM_RX_SIGNALS] =
{
    ...
    {
        /* S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx */
        &Com_Prv_RxSigS_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx_u8,
        0,            /*Handle Id*/
        /*
        {
            UpdBitConf:1;  = false
...
/* IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx has a TMS switch */
static const Com_TransModeInfo_tst Com_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx_TransModeInfo_acst[] =
{
...
{
    {   /*Ipdu: IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx*/

        &Com_dIP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_TxByte[0],              /*Pointer to the Ipdu Buffer*/
        
        &Com_Prv_TxIpduRam_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx_st,         /* pointer to RAM */

        Com_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx_TransModeInfo_acst,
        ...
        Com_TxNotify_Wrap_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx,
        #endif

        #ifdef COM_ERRORNOTIFICATION
        /* Error Notification part */

        Com_TxErrNotify_Wrap_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx,
        #endif

        #ifdef COM_TxIPduTimeOutNotify
        /* Timeout Notification part*/

        Com_TxTONotify_Wrap_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx,
        #endif
        ...
        PduRConf_PduRSrcPdu_ApplicationECU_To_TestECU_Com2PduR_Can_Network_Channel_CAN,              /* PduR Id */


        (Com_TxIntSignalId_tuo)ComSignal_Internal_S_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx,     /*Index to First Signal within this Ipdu*/
        #ifdef COM_TX_SIGNALGROUP
...
{
    {   /*Ipdu: IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx*/

        &Com_dIP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_RxByte[0],              /*Pointer to the Local Ipdu Buffer*/
        
        &Com_Prv_RxIpduRam_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx_st,         /* pointer to RAM */
        ...
        Com_RxTONotify_Wrap_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx,
        ...
        (Com_RxIntSignalId_tuo)ComSignal_Internal_S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx,   /*Index to First Signal within this Ipdu*/
         #ifdef COM_RX_SIGNALGROUP
        0,                            /*This IPDU does not contain any Signal Groups*/
        #endif
#ifdef COM_SIGNALGATEWAY
...
{
    {
        ...
        ComSignal_Internal_S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx,   /*Index to First Signal within this Ipdu*/
        #ifdef COM_RX_SIGNALGROUP
...
const Com_IpduId_tuo Com_Prv_xIPduGrp_IpduRefCfg_acuo[2] =
{
    ...
    ComIPdu_Internal_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx,
    /* ComIPduGroup_Tx */

    ComIPdu_Internal_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx
};
...
const Com_NEGMinMax_tst Com_NEGMinMax_acst[1] =
{
    /*  Min      Max */
    /* Signals */
    { 0, 0 }    /* S_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx */
