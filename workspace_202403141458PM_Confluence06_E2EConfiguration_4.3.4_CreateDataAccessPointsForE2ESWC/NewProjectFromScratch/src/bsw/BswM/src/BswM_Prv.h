...
#define BSWM_API_ID_ECUMCRNTST          ( 0x28 )
#define BSWM_API_ID_ECUMCURRWAKEUP      ( 0x10 )
#define BSWM_API_ID_ECUMRUNREQ          ( 0x29 )
...
#define BSWM_API_ID_NMCARWKUPIND        ( 0x24 )
