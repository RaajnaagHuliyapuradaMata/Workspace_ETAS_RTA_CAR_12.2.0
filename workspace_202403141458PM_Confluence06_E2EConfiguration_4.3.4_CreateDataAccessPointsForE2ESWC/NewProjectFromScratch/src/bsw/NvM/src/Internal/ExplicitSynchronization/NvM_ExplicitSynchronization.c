...
RBA_MEMLIB_LOCAL_INLINE boolean NvM_Prv_ExplicitSync_IsBlockSizeValid(NvM_BlockIdType idBlock_uo);

RBA_MEMLIB_LOCAL_INLINE NvM_Prv_JobResult_ten NvM_Prv_ExplicitSync_CallCopyFct(NvM_Prv_ExplicitSync_Copy_tpfct CopyFunction_pfct,
...
boolean NvM_Prv_ExplicitSync_CheckBlockSizes(void)
{
    ...
    {
        if (NvM_Prv_BlkDesc_IsBlockSelected(idBlock_uo, NVM_PRV_BLOCK_FLAG_USE_SYNC_MECHANISM))
        {
            if (NvM_Prv_BlkDesc_GetSize(idBlock_uo) > NvM_Prv_InternalBuffer_GetSize())
            {
                // BSW_SWCS_AR_NVRAMManager_Ext-3100 Indicate bad initialization
                                                    ...
                                                    uint8* RamBlock_pu8)
{
    ...
    (void)idBlock_uo;
    (void)cntrExpSyncOperations_pu8;
    (void)RamBlock_pu8;
...
RBA_MEMLIB_LOCAL_INLINE boolean NvM_Prv_ExplicitSync_IsBlockSizeValid(NvM_BlockIdType idBlock_uo)
{
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3049]
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3049] block size greater than size of the RAM mirror
