 ...
 **********************************************************************************************************************
*/
uint8 Com_SendSignalGroupWithMetaData(Com_SignalGroupIdType idSignalGroup_u16, const uint8 * metaDataPtr_pcu8)
{
    ...
    {
        COM_DET_REPORT_ERROR(COMServiceId_SendSignalGroupWithMetaData, COM_E_UNINIT);
    }
    else if (!Com_Prv_IsValidTxSignalGroupId(idSignalGroup_u16))
    {
        COM_DET_REPORT_ERROR(COMServiceId_SendSignalGroupWithMetaData, COM_E_PARAM);
    }
    else
