...
/* No redundant block present, replace calls of public functions via pointer with calls of dummy functions */
#define rba_FeeFs1x_InvJob_execInv_Red          rba_FeeFs1x_BlockJob_jobDummy
#define rba_FeeFs1x_InvJob_execInv_NoFBRed      rba_FeeFs1x_BlockJob_jobDummy
#  endif
...
#define rba_FeeFs1x_InvJob_execInv_UnknownBlk   rba_FeeFs1x_BlockJob_jobDummy
#  endif
...
extern void rba_FeeFs1x_InvJob_cancel(void);
 ...
 **********************************************************************************************************************
 */
LOCAL_INLINE void rba_FeeFs1x_InvJob_init(void);
LOCAL_INLINE void rba_FeeFs1x_InvJob_init(void)
{
