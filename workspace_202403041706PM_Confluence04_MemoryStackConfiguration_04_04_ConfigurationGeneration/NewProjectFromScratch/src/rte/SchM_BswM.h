...
#define SchM_Mode_BswM_MDGR_BswM_MRP_BswM_MDG()  ( 4 )
#endif
...
/* Inline read optimization; SchM_Switch_BswM_MDGP_AUTOSAR_BswM_ModeDeclarationGroups_MDG_ECUM_STATE to direct read */
#define SchM_Switch_BswM_MDGP_AUTOSAR_BswM_ModeDeclarationGroups_MDG_ECUM_STATE( data )  ( ((VAR(Std_ReturnType, AUTOMATIC))SCHM_E_OK) )
#endif
