...
typedef enum {
	...
	BSWM_ACTION_SD_SERVICE_GROUP_SWITCH,
...
typedef enum {
	BSWM_COMM_FULL_COMMUNICATION, BSWM_COMM_NO_COMMUNICATION
 ...
 * - Specifies if the requested communication mode is BSWM_COMM_FULL_COMMUNICATION/BSWM_COMM_NO_COMMUNICATION
 ...
 **********************************************************************************************************************
 */
#define BSWM_NO_OF_AC_CLEAR_EVENT_REQUEST      0u
...
#define BSWM_NO_OF_AC_CORE_HALT_MODE           0u
#define BSWM_NO_OF_AC_DEADLINE_MONITOR_CNTRL   0u
#define BSWM_NO_OF_AC_BSWM_ECUMGODOWN_HALT_POLL     0u
#define BSWM_NO_OF_AC_ECUM_SELECT_SHUTDOWN_TARGET   0u
#define BSWM_NO_OF_AC_ECUMSTATESWITCH          0u
#define BSWM_NO_OF_AC_ECUMDRIVERINITLISTBSWM   0u   
#define BSWM_NO_OF_AC_ETHIF_START_ALL_PORTS    0u
#define BSWM_NO_OF_AC_ETHIFMODESWITCH          0u
#define BSWM_NO_OF_AC_FR_SM_ALL_SLOTS          0u
#define BSWM_NO_OF_AC_IDSM_BLOCK_STATE_CHANGE_REQUEST          0u
...
#define BSWM_NO_OF_AC_USERCALLOUT              24u
...
#define BSWM_NO_OF_AC_SDSERVICE_GROUP_SWITCH   0u
...
extern void BswM_Cfg_BswMClearEventRequestFunction(
		uint16 idBswMClearEventRequest_u16);
