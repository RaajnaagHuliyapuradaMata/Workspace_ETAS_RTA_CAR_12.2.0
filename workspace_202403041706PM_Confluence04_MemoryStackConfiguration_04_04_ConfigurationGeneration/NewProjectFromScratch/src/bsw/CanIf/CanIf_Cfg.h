...
#define CanIfConf_CanIfTxPduCfg_ApplicationECU_TestResult_Tx_Can_Network_CANNODE_0_OUT        0
...
#define CanIfConf_CanIfRxPduCfg_TestECU_TestCode_Tx_Can_Network_CANNODE_0_IN        0
