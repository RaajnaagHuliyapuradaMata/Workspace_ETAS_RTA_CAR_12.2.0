...
/* ------------------------------------------------- */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_START_SEC_CODE_OSTASKAUTOSTART
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_OsTaskAutoStart(void);
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_CODE_OSTASKAUTOSTART
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
...
#define OsTaskAutoStart (&Os_const_tasks0[2])
#define OS_TPL_FOR_OsTaskAutoStart (2U) /* [$UKS 2007] */
#define OS_IMASK_FOR_OsTaskAutoStart (0U) /* [$UKS 2009] */
#define OS_INDEX_FOR_OsTaskAutoStart (2U) /* [$UKS 2185] */
DeclareTask(OsTaskAutoStart)
