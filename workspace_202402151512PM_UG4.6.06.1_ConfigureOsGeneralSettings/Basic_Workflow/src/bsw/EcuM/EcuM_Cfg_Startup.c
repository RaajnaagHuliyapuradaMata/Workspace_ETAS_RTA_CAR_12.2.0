...
{
 /*End Of DriverInitListZero Condition Check*/
}
...
void EcuM_AL_DriverInitOne( const EcuM_ConfigType * ConfigPtr )
{
    ...
    EcuM_DriverInitOne_begin_ticks_u64    =   EcuM_GetTicks();
                    ...
                    (void)CanIf_Init(ConfigPtr->ModuleInitPtrPB.CanIfInitConfigPtr_cpst);
            
                    (void)CanSM_Init(ConfigPtr->ModuleInitPtrPB.CanSMInitConfigPtr_cpst);
            
                    (void)PduR_Init(ConfigPtr->ModuleInitPtrPB.PduRInitConfigPtr_cpst);
            
                    (void)Com_Init(ConfigPtr->ModuleInitPtrPB.ComInitConfigPtr_cpst);
            
                    (void)ComM_Init(ConfigPtr->ModuleInitPtrPB.ComMInitConfigPtr_cpst);
            
        
#if ECUM_STARTUP_DURATION == TRUE /*will activate the Run time measurement First*/
 
    EcuM_DriverInitOne_end_ticks_u64    =   EcuM_GetTicks();

    EcuM_DriverInitZero_delta_us_u32 = (uint32)EcuM_GetDuration(EcuM_DriverInitZero_end_ticks_u64,EcuM_DriverInitZero_begin_ticks_u64);
    EcuM_DriverInitZero_LastReset_begin_us_u32 = (uint32)EcuM_GetTicksSinceLastReset(EcuM_DriverInitZero_begin_ticks_u64);
    EcuM_DriverInitOne_delta_us_u32 = (uint32)EcuM_GetDuration(EcuM_DriverInitOne_end_ticks_u64,EcuM_DriverInitOne_begin_ticks_u64);
    EcuM_DriverInitOne_LastReset_begin_us_u32 = (uint32)EcuM_GetTicksSinceLastReset(EcuM_DriverInitOne_begin_ticks_u64);
    EcuM_DeterminePbConfiguration_delta_us_u32 = (uint32)EcuM_GetDuration(EcuM_DeterminePbConfiguration_end_ticks_u64,EcuM_DeterminePbConfiguration_begin_ticks_u64);
    EcuM_DeterminePbConfiguration_LastReset_begin_us_u32 = (uint32)EcuM_GetTicksSinceLastReset(EcuM_DeterminePbConfiguration_begin_ticks_u64);
