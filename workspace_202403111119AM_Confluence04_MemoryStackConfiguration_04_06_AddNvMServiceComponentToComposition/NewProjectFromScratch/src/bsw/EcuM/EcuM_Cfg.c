...
/*************************************************************************************************
Container Name    : EcuMWakeupSource
Description       : Contains the list of ComM Channel references linked to each WakeupSource
****************************************************************************************************/
...
{/*nbrOfComChannelPresent,       ComChannelReferance,                     ResetReason,             ValidationTimeout,   IsWakeupSourcePolling,                WakeupSourceId,                     CheckWakeupTimeout                  */
{      0 ,       NULL_PTR                                   ,  MCU_RESET_UNDEFINED   ,         0         ,        FALSE  ,              EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_POWER,               
    0             },
{      0 ,       NULL_PTR                                   ,  MCU_RESET_UNDEFINED   ,         0         ,        FALSE  ,              EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_RESET,               
    0             },
{      0 ,       NULL_PTR                                   ,  MCU_RESET_UNDEFINED   ,         0         ,        FALSE  ,              EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_INTERNAL_RESET,               
    0             },
{      0 ,       NULL_PTR                                   ,  MCU_RESET_UNDEFINED   ,         0         ,        FALSE  ,              EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_INTERNAL_WDG,               
    0             },
{      0 ,       NULL_PTR                                   ,  MCU_RESET_UNDEFINED   ,         0         ,        FALSE  ,              EcuMConf_EcuMWakeupSource_ECUM_WKSOURCE_EXTERNAL_WDG,               
    0             }
};
