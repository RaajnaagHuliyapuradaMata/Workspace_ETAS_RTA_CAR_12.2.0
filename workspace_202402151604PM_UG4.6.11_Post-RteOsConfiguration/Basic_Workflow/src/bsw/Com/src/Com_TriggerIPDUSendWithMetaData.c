 ...
 **********************************************************************************************************************
*/
/* MR12 RULE 8.13 VIOLATION: A pointer parameter(metaData_pu8) in a function prototype should be declared as
 * pointer to const if the pointer is not used to modify the addressed object. But AUTOSAR SWS specification
 * signature is as below. Hence suppressed */
...
# endif /* end of COM_PRV_ERROR_HANDLING */
    {
        ...
        * If PC variant is selected, then no mapping table will be used. */
        ...
        if (txIpduConstPtr_pcst->txMetaDataPtr_pcst != NULL_PTR)
        {
...
# ifdef COM_TxIPduTimeOut
                    ...
                    sendIpduFlag_st.isTimeoutReq_u1 = COM_BOOL_TO_UNSIGNED(txIpduConstPtr_pcst->timeout_u16
                                                                                                        != COM_ZERO);
# endif
