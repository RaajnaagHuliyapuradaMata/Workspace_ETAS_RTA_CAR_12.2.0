...
typedef P2CONST(struct Rte_CDS_MySWC,AUTOMATIC,RTE_CONST) Rte_SelfType_MySWC;

typedef P2CONST(struct Rte_CDS_rba_DiagLib,AUTOMATIC,RTE_CONST) Rte_SelfType_rba_DiagLib;

typedef P2FUNC(VAR(Std_ReturnType, AUTOMATIC), RTE_CODE, Rte_WriteFP_MySWC_My_SR_Interface_DE_MyDataElement) (VAR(uint8, AUTOMATIC) data);
