...
{
    /* IP_TestECU_TestCode_Tx_Can_Network_Channel_CAN_Rx */
    {
        8u,    /* PduLength */
        5   /* fields */
    }
...
{
    /* IP_ApplicationECU_TestResult_Tx_Can_Network_Channel_CAN_Tx */
    {
        8u,    /* PduLength */
        PduRConf_PduRSrcPdu_ApplicationECU_TestResult_Tx_Com2PduR_Can_Network_Channel_CAN,    /* PduR Tx Handle-ID */
        0   /* fields */
    }
};
...
#define Com_RxSAckCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo (NULL_PTR)

#define Com_RxSInvCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo (NULL_PTR)

#define Com_RxSToutCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo (NULL_PTR)
...
const Com_Prv_xRxSigVarCfg_tst Com_Prv_xRxSigVarCfg_acst[] =
{
    /* S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx */
    {
        Com_RxSAckCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo, /* ackCbk_pcauo */
        Com_RxSToutCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo, /* toutCbk_pcauo */
        Com_RxSInvCbkIdx_S_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_cauo /* invCbk_pcauo */
    }
};
