 ...
 *
 **********************************************************************************************************************
    CONTAINS FIX TYPE DECLARATIONS, FORWARD DECLARATIONS TO GENERATED TYPES AND FUNCTION PROTOTYPES
    CONTAIN API INTERFACE DECLARATIONS FOR ALL ECUM MODULE SERVICES
**********************************************************************************************************************
*/
...
#define ECUM_STATE_RUN                       (EcuM_StateType)(0x32U)
#define ECUM_STATE_POST_RUN                  (EcuM_StateType)(0x33U)
