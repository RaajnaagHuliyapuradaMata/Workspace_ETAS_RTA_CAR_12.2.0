 ...
 */
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3119]
 ...
 */
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3123]
 ...
 */
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3129]
NvM_BlockIdType NvM_Rb_idLastWrittenBlock_uo;
/**
 * Write request counters which will be stored in persistent way.
 */
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3128]
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3135]
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3136]
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3137]
...
void NvM_Prv_WriteMonCntrHandling(NvM_BlockIdType idBlock_uo, uint16 BlockLength_u16, boolean isCallBeforeCrcCalc_b)
{
    ...
    if ( ((boolean)TRUE == isCallBeforeCrcCalc_b) != (NvMConf_NvMBlockDescriptor_NvM_WriteMon != idBlock_uo) )
    {
...
LOCAL_INLINE void NvM_Prv_IncreaseWriteCounters(NvM_BlockIdType idBlock_uo, uint16 BlockLength_u16)
{
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3156] All counters shall have overflow protection
