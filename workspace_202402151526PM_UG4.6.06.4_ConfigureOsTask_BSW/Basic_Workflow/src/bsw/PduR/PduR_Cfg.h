...
#if !defined(PDUR_RBA_J1939FDTP_SUPPORT)
#define PDUR_RBA_J1939FDTP_SUPPORT    (0)
#endif /* PDUR_RBA_J1939FDTP_SUPPORT */
...
#if !defined(PDUR_SD_SUPPORT)
#define PDUR_SD_SUPPORT    (0)
#endif /* PDUR_SD_SUPPORT */



#if !defined(PDUR_RBA_EBDATACLIENT_SUPPORT)
#define PDUR_RBA_EBDATACLIENT_SUPPORT    (0)
#endif /* PDUR_RBA_EBDATACLIENT_SUPPORT */



#if !defined(PDUR_IDSM_SUPPORT)
#define PDUR_IDSM_SUPPORT    (0)
#endif /* PDUR_IDSM_SUPPORT */
...
#define PDUR_DET_MODULE_AVAILABLE 
 ...
 * typedef struct\n
 *  {\n
 *  const void * PduR_PBConfigDataPtr;        Pointer to PduR Base structure \n
