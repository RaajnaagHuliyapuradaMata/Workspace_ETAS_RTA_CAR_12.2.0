...
#define BSWM_NO_OF_BSWMODENOTIFICATION              2u 
...
#define BSWM_CFG_USERID_MRP_R_BSWM_AR_INITBLOCKTWO_0    2

/* BswMSwcModeNotification - IDs of BswMSwcModeNotification */
#define BSWM_CFG_USERID_BSWM_MRP_SWCMODEREQUEST    3
...
#define BSWM_IDX_MRP_R_BSWM_AR_INITBLOCKTWO_0         2

/* BswMSwcModeNotification - Indexes of BswMSwcModeNotification */
#define BSWM_IDX_BSWM_MRP_SWCMODEREQUEST         3
