...
E2E_INLINE uint16 E2E_Prv_P44ReadU16(const uint8 * const Data_pu8, uint32 offset_u32)
{
    ...
    return (((uint16)((uint16)Data_pu8[offset_u32] << 8U)) | 
            ((uint16)Data_pu8[offset_u32 + 1U]));
}
...
E2E_INLINE void E2E_Prv_P44WriteU16(uint8 * const Data_pu8, uint32 offset_u32, uint16 value_u16)
{
    ...
    Data_pu8[offset_u32]      = (uint8)(value_u16 >> 8U);
    Data_pu8[offset_u32 + 1U] = (uint8)(value_u16);
}
                                         ...
                                         uint16 Length_u16)
{
    ...
    /* MR12 Rule 10.4 Violation: Type casting does not lead to any functional issue */
