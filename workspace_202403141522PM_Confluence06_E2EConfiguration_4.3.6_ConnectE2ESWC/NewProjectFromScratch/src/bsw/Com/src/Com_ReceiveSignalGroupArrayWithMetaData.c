...
# if (COM_PRV_ERROR_HANDLING == STD_ON)
    ...
    {
        COM_DET_REPORT_ERROR(COMServiceId_ReceiveSignalGroupArrayWithMetaData, COM_E_UNINIT);
    }
    else if ((signalGroupArrayPtr_pu8 == NULL_PTR) || (metaDataPtr_pu8 == NULL_PTR))
    {
        COM_DET_REPORT_ERROR(COMServiceId_ReceiveSignalGroupArrayWithMetaData, COM_E_PARAM_POINTER);
    }
    else if (!Com_Prv_IsValidRxSignalGroupId(idSignalGroup_u16))
    {
        COM_DET_REPORT_ERROR(COMServiceId_ReceiveSignalGroupArrayWithMetaData, COM_E_PARAM);
    }
    else
