 ...
 */
//-----------------------------------------------------------------------------------------------------------
// Extern declaration allowance helpers
//-----------------------------------------------------------------------------------------------------------

/* Condition for adding externs conflicting with Rte in a) own sources and in b) rte.c */
/* Note: Define NVM_RB_IGNORE_RTE_CORE in Rte_UserCfg.h or compiler-invocation in case of issues in rte.c */
#if (  (!defined(NVM_RB_HIDE_RTEAPI)) && ( !defined(RTE_CORE) || defined(NVM_RB_IGNORE_RTE_CORE) )  )
#define NVM_RB_ALLOW_EXTERN_HELPER   TRUE
#else
#define NVM_RB_ALLOW_EXTERN_HELPER   FALSE
#endif

#if (  (!defined(NVM_RB_HIDE_MAINFUNC_RTEAPI)) && ( !defined(RTE_CORE) || defined(NVM_RB_IGNORE_RTE_CORE) )  )
#define NVM_RB_ALLOW_EXTERN_MAINFUNC_HELPER   TRUE
#else
#define NVM_RB_ALLOW_EXTERN_MAINFUNC_HELPER   FALSE
#endif
...
#define NVM_SERVICE_ID_RB_ENTER_HIGH_SPEED_MODE                       (225u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3456] Service to enter high-speed-mode
#define NVM_SERVICE_ID_RB_EXIT_HIGH_SPEED_MODE                        (226u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3458] Service to exit high-speed-mode
#define NVM_SERVICE_ID_RB_GET_BLOCK_ERRORS                            (227u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3454] Service to get the block errors for a NVRAM block
#define NVM_SERVICE_ID_RB_AUX_GET_ERROR_INFO_DETAIL                   (228u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3402] Service to read out error information details after a failing read of auxilary user
#define NVM_SERVICE_ID_RB_GET_ERROR_INFO_DETAIL                       (229u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3401] Service to read out error information details after a failing read
#define NVM_SERVICE_ID_RB_GET_WRITE_COUNTER                           (230u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3285]
#define NVM_SERVICE_ID_RB_GET_BLOCK_TYPE                              (231u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3169] Service to get block type
#define NVM_SERVICE_ID_RB_IS_INIT_AT_LAYOUT_CHANGE_ENQUEUED           (232u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3167] Service to determine if InitAtLayoutChange is enqueued
#define NVM_SERVICE_ID_RB_IS_BLOCK_SELECTED_FOR_INIT_AT_LAYOUT_CHANGE (233u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3164] Service to determine if block is selected for InitAtLayoutChange
#define NVM_SERVICE_ID_RB_IS_BLOCK_SELECTED_FOR_FIRST_INIT_ALL        (234u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3162] Service to determine if block is selected for FirstInitAll
#define NVM_SERVICE_ID_RB_CLR_WRITE_MON_CNTRS                         (235u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3122] Service to clear write monitoring counters
#define NVM_SERVICE_ID_RB_GET_BLOCK_ID_CAUSING_LAST_DET_ERROR         (236u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3113] Service to get the block ID used in NvM service which has caused the last DET error
#define NVM_SERVICE_ID_RB_GET_REQUEST_TYPE                            (237u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3105] Service to get the type of the currently active block request
#define NVM_SERVICE_ID_RB_AUX_GET_MIGRATION_RESULT                    (238u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3053] Service to read the result of AUX migration operation
#define NVM_SERVICE_ID_RB_GET_MIGRATION_RESULT                        (239u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3052] Service to read the result of migration operation
#define NVM_SERVICE_ID_RB_INIT_RUNTIME_RAM_PROPERTIES                 (240u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3031] Service to initialize the runtime caclulated RAM block properties
#define NVM_SERVICE_ID_RB_SET_WRITEALL_TRIGGER                        (241u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2977] Service to trigger NvM_WriteAll even if the RAM state is unchanged
...
#define NVM_SERVICE_ID_RB_AUX_GET_DATA_INDEX                          (243u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2940]
#define NVM_SERVICE_ID_RB_AUX_GET_ERROR_STATUS                        (244u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2939]
#define NVM_SERVICE_ID_RB_AUX_INVALIDATE_NV_BLOCK                     (245u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2942]
#define NVM_SERVICE_ID_RB_AUX_READ_BLOCK                              (246u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2943]
#define NVM_SERVICE_ID_RB_AUX_SET_DATA_INDEX                          (247u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2941]
#define NVM_SERVICE_ID_RB_AUX_WRITE_BLOCK                             (248u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2944]
// #define NVM_PRV_SERVICE_ID_MAINTAIN_BLOCK                          (249u) Redundant block maintenance service ID (currently defined in NvM_Prv.h)
#define NVM_SERVICE_ID_RB_GET_BLOCK_ID                                (250u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2840]
#define NVM_SERVICE_ID_RB_FIRST_INIT_ALL                              (251u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2826]
#define NVM_SERVICE_ID_RB_GET_ACTIVE_SERVICE                          (252u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2827]
#define NVM_SERVICE_ID_RB_GET_NV_BLOCK_LENGTH                         (253u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2791]
...
#define NVM_SERVICE_ID_RB_REMOVE_NON_RESISTANT                        (254u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2787]
                                                                             // Note: REMOVE_NON_RESISTANT service ID is deprecated. INIT_AFTER_READ_ALL service ID should be used instead.
#define NVM_SERVICE_ID_RB_GET_STATUS                                  (255u) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2750]
...
#define NVM_E_WRITE_ONCE_STATUS_UNKNOWN         (0x1Au) // TRACE[SWS_NvM_91004]
                                                        // This error is used only for AR4.5 and newer
...
#define NVM_E_BLOCK_CIPHER_LENGTH_MISSMATCH     (0x1Cu) // TRACE[SWS_NvM_91004]
                                                        // In AR4.6 0x1B is used for NVM_E_WRITE_PROTECTED and
                                                        // NVM_E_BLOCK_CIPHER_LENGTH_MISSMATCH. To avoid mistakes
                                                        // NvM uses 0x1C for NVM_E_BLOCK_CIPHER_LENGTH_MISSMATCH

// TRACE[NVM024] Additional DET errors that are detected because of specific implementation
#define NVM_E_LENGTH_MAC                    (0xF3u) // Length of message authentication code (MAC) differs from the configured one
#define NVM_E_CRYPTO_CSM_BUSY               (0xF4u) // NvM cannot start a Csm job because Csm is busy
#define NVM_E_CRYPTO_WRITE_NO_INIT_VECTOR   (0xF5u) // No random number available to be used as initialization vector
                                                    // for encryption/authentication
#define NVM_E_CRYPTO_JOB_ID                 (0xF6u) // A callback for Csm jobs has been invoked for a Csm job not started before
#define NVM_E_LENGTH_RANDOM_NUMBER          (0xF7u) // Length of random number differs from the configured one
#define NVM_E_LENGTH_AEAD_TAG               (0xF8u) // Length of the tag used for AEAD encryption differs from the configured one
#define NVM_E_LENGTH_SIGNATURE              (0xF9u) // Length of signature differs from the configured one
#define NVM_E_REENTRANT                     (0xFAu) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3266] Re-entrant main function
...
#define NVM_E_RAM_MIRROR_SIZE               (0xFEu) // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3049]
                                                    // NV block length greater then explicit RAM mirror size
...
#define NVM_BLOCK_STATE_RAM_VALID               (0x0001u) // TRACE[NVM132] RAM block is valid
                                                          // TRACE[NVM133] (invalid = !valid)
#define NVM_BLOCK_STATE_RAM_CHANGED             (0x0002u) // RAM block is changed
#define NVM_BLOCK_STATE_RAM_MASK                (0x0003u) // RAM block attribute mask
#define NVM_BLOCK_STATE_RAM_VALID_CHANGED       (0x0003u) // RAM block is valid and changed

// Extended bit mask which has to be set for triggering NvM_WriteAll
// -------------------------------------------------------
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2977] Add a separate flag to enable/disable NvM_SetWriteAllTrigger
#define NVM_RB_BLOCK_STATE_MASK_TRG_WRITEALL    (0x0004u)

// TRACE[NVM054] Write protection
#define NVM_BLOCK_STATE_WRITE_PROT              (0x0008u) // Block is write protected
 ...
 */
#define NVM_BLOCK_STATE_RAM_CRC_WRITE_REQ       (0x0010u)
 ...
 * for the block.
 */
#define NVM_BLOCK_STATE_RAM_CRC_RECALC_ONGOING  (0x0020u)
 ...
 */
#define NVM_BLOCK_STATE_RAM_CRC_RECALC_REQ      (0x0040u)
 ...
 */
#define NVM_BLOCK_STATE_READ_DONE               (0x0080u)

/**
 * Bit mask definition to access the bit which indicates (when set) that a job is currently ongoing for the block.
 */
#define NVM_BLOCK_STATE_JOB_ONGOING             (0x0100u)
...
//-----------------------------------------------------------------------------------------------------------
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3157] Block ID used for the configuration ID
#define NVM_RB_CONFIG_ID_BLOCK     (1u)
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2848] ID of the first NvM user block
...
//-----------------------------------------------------------------------------------------------------------
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2801] Function-like macro for retrieving the configured NV block length
//                                         of an NvM block
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2812] public summary production errors' variable (index # 0)
// This is a public API and shall as such hide implementation-specific details such as the additional admin block for
// auxiliary users, hence it only has NVM_CFG_NR_ALL_BLOCKS entries, not NVM_PRV_NR_BLOCKS_ADMIN
extern uint8 NvM_Rb_stBlockErrors_au8[NVM_CFG_NR_ALL_BLOCKS];
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3131]
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3132]
...
// Declaration of the service for MainFunction and Dependency invocation
extern void NvM_Rb_MainFunctionAndDependency(void);

// avoid double or missing declaration
#if NVM_RB_ALLOW_EXTERN_HELPER
/**
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3322] Support API overloading for NvM_SetDataIndex
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_SetDataIndexBase(NvM_BlockIdType BlockId, uint8 DataIndex);
#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2840] Service to get the NvM block ID
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3321] Support API overloading for NvM_SetBlockProtection
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_SetBlockProtectionBase(NvM_BlockIdType BlockId, boolean ProtectionEnabled);
#endif
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3412] Support API overloading for NvM_GetErrorStatus
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_GetErrorStatusBase(NvM_BlockIdType BlockId, NvM_RequestResultType *RequestResultPtr);
#endif
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3323] Support API overloading for NvM_SetRamBlockStatus
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_SetRamBlockStatusBase(NvM_BlockIdType BlockId, boolean BlockChanged);
#endif
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3320] Support API overloading for NvM_SetBlockLockStatus
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern void NvM_Rb_SetBlockLockStatusBase(NvM_BlockIdType BlockId, boolean BlockLocked);
#endif
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3052] Service to read the result of migration operation
...
extern Std_ReturnType NvM_Rb_GetErrorInfoDetail(NvM_BlockIdType BlockId, NvM_Rb_ErrorInfoDetail_ten *result_pen);
#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2791] Service for getting the configured NV block length
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3319] Support API overloading for NvM_Rb_SetWriteAllTrigger
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_SetWriteAllTriggerBase(NvM_BlockIdType BlockId, boolean WriteAllTrigger);
# endif

#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3285] Service to get current block write counter
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2940] Service for getting the currently set DataIndex
//                                               of a dataset NVRAM block
extern Std_ReturnType NvM_Rb_AuxGetDataIndex(uint8 *DataIndexPtr);
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2939] Service to read the block dependent error/status information
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3413] Support API overloading for NvM_Rb_AuxGetErrorStatus
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_AuxGetErrorStatusBase(NvM_RequestResultType *RequestResultPtr);
# endif

#if (NVM_RB_ERROR_INFO_DETAIL == STD_ON)
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3402] Service to read out error information details after a failing read of auxilary user
extern Std_ReturnType NvM_Rb_AuxGetErrorInfoDetail(NvM_Rb_ErrorInfoDetail_ten *result_pen);
#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2941] Service for setting the DataIndex of a dataset NVRAM block
extern Std_ReturnType NvM_Rb_AuxSetDataIndex(uint8 DataIndex);

# ifdef NVM_CFG_API_RB_AUX_SET_DATA_INDEX
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3318] Support API overloading for NvM_Rb_AuxSetDataIndex
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
extern Std_ReturnType NvM_Rb_AuxSetDataIndexBase(uint8 DataIndex);
# endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3053] Service to read the result of AUX migration operation
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3454]  API to provide NvM_Rb_stBlockErrors_au8[idBlock_uo]
extern Std_ReturnType NvM_Rb_GetBlockErrors(NvM_BlockIdType idBlock_uo, NvM_Rb_BlockErrors_tuo* BlockErrors_puo );

#if (NVM_RB_REQ_MONITOR == NVM_RB_REQ_MON_WRITE)
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3122] Service to clear write monitoring counters
extern Std_ReturnType NvM_Rb_ClrWriteMonCntrs(void);
#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3169] Service to get block type
extern NvM_BlockManagementType NvM_Rb_GetBlockType(NvM_BlockIdType BlockId);
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3167] Service to determine if InitAtLayoutChange is enqueued
extern boolean NvM_Rb_IsInitAtLayoutChangeEnqueued(void);
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3164] Service to determine if block is selected for InitAtLayoutChange
extern boolean NvM_Rb_IsBlockSelectedForInitAtLayoutChange(NvM_BlockIdType BlockId);
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3162] Service to determine if block is selected for FirstInitAll
...
extern Std_ReturnType NvM_Rb_EnterHighSpeedMode(void);
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3458] Service to exit the high-speed-mode
extern Std_ReturnType NvM_Rb_ExitHighSpeedMode(void);
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2910] Support API overloading for NvM_ReadBlock
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3280] Support API overloading for NvM_ReadPRAMBlock
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2913] Support API overloading for NvM_WriteBlock
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern Std_ReturnType NvM_RestoreBlockDefaults(NvM_BlockIdType BlockId, NvM_Rb_VoidPtr NvM_DstPtr);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2911] Support API overloading for NvM_RestoreBlockDefaults
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern Std_ReturnType NvM_RestorePRAMBlockDefaults(NvM_BlockIdType BlockId);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3282] Support API overloading for NvM_RestorePRAMBlockDefaults
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern Std_ReturnType NvM_EraseNvBlock(NvM_BlockIdType BlockId);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2907] Support API overloading for NvM_EraseNvBlock
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern Std_ReturnType NvM_InvalidateNvBlock(NvM_BlockIdType BlockId);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2908] Support API overloading for NvM_InvalidateNvBlock
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
#if (NVM_RB_AUX_INTERFACE == STD_ON)
// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2942] Service to invalidate a NV block
extern Std_ReturnType NvM_Rb_AuxInvalidateNvBlock(NvM_BlockIdType BlockId);
# ifdef NVM_CFG_API_RB_AUX_INVALIDATE_NV_BLOCK
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3275] Support API overloading for NvM_Rb_AuxInvalidateNvBlock
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
    extern Std_ReturnType NvM_Rb_AuxInvalidateNvBlockBase(NvM_BlockIdType BlockId);
# endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2943] Service to copy the data of the NV block to its corresponding RAM block
extern Std_ReturnType NvM_Rb_AuxReadBlock(NvM_BlockIdType BlockId, void *NvM_DstPtr);
# ifdef NVM_CFG_API_RB_AUX_READ_BLOCK
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3276] Support API overloading for NvM_Rb_AuxReadBlock
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
    extern Std_ReturnType NvM_Rb_AuxReadBlockBase(NvM_BlockIdType BlockId, void *NvM_DstPtr);
# endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2944] Service to copy the data of the RAM block to its corresponding NV block
...
# ifdef NVM_CFG_API_RB_AUX_WRITE_BLOCK
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3277] Support API overloading for NvM_Rb_AuxWriteBlock
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern void NvM_ReadAll(void);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2909] Support API overloading for NvM_ReadAll
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern void NvM_WriteAll(void);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2912] Support API overloading for NvM_WriteAll
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern void NvM_CancelWriteAll(void);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3274] Support API overloading for NvM_CancelWriteAll
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
    extern void NvM_Rb_CancelWriteAllBase(void);
#endif

// TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2826] Service to trigger a multi block (re-) initialization operation
extern void NvM_Rb_FirstInitAll(void);
#ifdef NVM_CFG_API_RB_FIRST_INIT_ALL
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3278] Support API overloading for NvM_Rb_FirstInitAll
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
extern void NvM_ValidateAll(void);
    ...
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-3279] Support API overloading for NvM_ValidateAll
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2916] Also publish the base function in case of API overloading
    // TRACE[BSW_SWCS_AR_NVRAMManager_Ext-2915] Naming pattern for the base function: Rb infix, Base suffix
...
// --------------------
// avoid double or missing declaration
#if NVM_RB_ALLOW_EXTERN_MAINFUNC_HELPER
/**
...
/* Additional future MainFunction for initialization/shutdown loops (relevant in Multi-ASIL context) */
#define NvM_Rb_MainFunction_All       NvM_MainFunction
