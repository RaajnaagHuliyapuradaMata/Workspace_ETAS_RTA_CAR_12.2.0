...
#include "Com_MemMap.h"
    uint8 Com_dIP_ApplicationECU_TestResult_Tx_Can_Network_Channel_CAN_TxByte[8];
...
#define COM_START_SEC_VAR_CLEARED_8
#include "Com_MemMap.h"
    uint8 Com_dIP_TestECU_TestCode_Tx_Can_Network_Channel_CAN_RxByte[8];
...
#define COM_START_SEC_VAR_CLEARED_8
#include "Com_MemMap.h"
    uint8 Com_Prv_RxSigS_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_u8;
...
#include "Com_MemMap.h"
    Com_RxSignalFlagType_tst Com_Prv_RxSigFlagS_TestECU_SG_TestCode_Tx_Can_Network_Channel_CAN_Rx_st;
...
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "Com_MemMap.h"
    Com_TxSignalFlagType_tst Com_Prv_TxSigFlagS_ApplicationECU_SG_TestResult_Tx_Can_Network_Channel_CAN_Tx_st;
...
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "Com_MemMap.h"
Com_RxIpduRamData_tst Com_Prv_RxIpduRam_IP_TestECU_TestCode_Tx_Can_Network_Channel_CAN_Rx_st;
...
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "Com_MemMap.h"
Com_TxIpduRamData_tst Com_Prv_TxIpduRam_IP_ApplicationECU_TestResult_Tx_Can_Network_Channel_CAN_Tx_st;
