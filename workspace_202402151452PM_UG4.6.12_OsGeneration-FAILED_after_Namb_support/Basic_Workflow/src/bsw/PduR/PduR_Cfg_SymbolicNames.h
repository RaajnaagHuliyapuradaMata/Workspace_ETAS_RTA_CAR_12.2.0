...
#define PduRConf_PduRSrcPdu_TestECU_To_ApplicationECU_CanIf2PduR_Can_Network_Channel_CAN    0
#define PduRConf_PduRSrcPdu_ApplicationECU_To_TestECU_Com2PduR_Can_Network_Channel_CAN    0
#define PduRConf_PduRDestPdu_TestECU_To_ApplicationECU_PduR2Com_Can_Network_Channel_CAN  0
#define PduRConf_PduRDestPdu_ApplicationECU_To_TestECU_PduR2CanIf_Can_Network_Channel_CAN  0
