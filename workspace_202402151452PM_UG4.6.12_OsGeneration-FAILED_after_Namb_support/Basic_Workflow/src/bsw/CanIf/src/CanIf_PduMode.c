                                                 ...
                                                 )
{
...
#endif
#if ((CANIF_DEV_ERROR_DETECT == STD_ON)||(CANIF_PUBLIC_TXBUFFERING == STD_ON)||(CANIF_PUBLIC_PN_SUPPORT == STD_ON) || (CANIF_XCORE_CFG_ENABLED != STD_OFF))
    ...
    CANIF_DET_REPORT_ERROR_INIT_NOT_OK((FALSE == CanIf_Prv_InitStatus_b), CANIF_SET_PDU_MODE_SID, CANIF_E_UNINIT)
    ...
    if((((lControllerState_p->Ctrl_Pdu_mode)&CANIF_BIT_MASK_PDU_MODE)>>CANIF_Ctrl_BIT_SHIFT)!= (uint8)CAN_CS_STARTED)/*[SWS_CANIF_00874]*/
                                                 ...
                                                 )
{
    ...
    CANIF_DET_REPORT_ERROR_INIT_NOT_OK((FALSE == CanIf_Prv_InitStatus_b), CANIF_GET_PDU_MODE_SID, CANIF_E_UNINIT)
