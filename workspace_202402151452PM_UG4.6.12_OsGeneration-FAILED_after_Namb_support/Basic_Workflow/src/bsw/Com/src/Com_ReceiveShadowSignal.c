...
void Com_Prv_ReceiveShadowSignal(Com_SignalIdType idSignal_u16, void * signalDataPtr_pv)
{
    ...
    idRxMainFunc_uo = (COM_GET_RX_IPDU_CONSTDATA(
                       (COM_GET_RXSIGGRP_CONSTDATA(rxGrpSigConstPtr_pcst->idSigGrp_uo))->idComIPdu_uo))->idMainFunc_uo;
 ...
 **********************************************************************************************************************
*/
/* MR12 RULE 8.13 VIOLATION: This is a false positive warning, 'signalDataPtr_pv' is modified and so the pointer
* cannot be changed to type 'pointer to const'. Hence warning is suppressed. */
LOCAL_INLINE void Com_Prv_CopyData_GrpSig_UnsignedType(
                                            Com_SignalIdType        idIntSignal_u16,
                                            void *                  signalDataPtr_pv,
                                            Com_MainFunc_tuo        idRxMainFunc_uo
...
# endif /* #ifdef COM_RXGRPSIG_INT64 */
        ...
        case COM_BOOLEAN:
        {
            ...
            * pointer address. Hence this warning can safely be ignored.
            */
            *(boolean*)signalDataPtr_pv = (COM_GET_RXGRPSIGTYPEUINT8_BUFF(idRxMainFunc_uo,idxGrpSigBuff_uo) !=
                                                                                                            COM_ZERO);
        ...
        case COM_UINT8_N:
        {
            ...
            * pointer address. Hence this warning can safely be ignored. */
            Com_ByteCopy( (uint8*)signalDataPtr_pv,
                        &(COM_GET_RXGRPSIGTYPEUINT8_BUFF(idRxMainFunc_uo,idxGrpSigBuff_uo)),
