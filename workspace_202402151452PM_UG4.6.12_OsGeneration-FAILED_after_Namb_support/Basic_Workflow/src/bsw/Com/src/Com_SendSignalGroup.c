...
#endif
    {
        ...
        * shall not impact the system behaviour. Hence suppressed. */
        ...
        if (COM_SIG_TP_IS_TRIGGERED_ON_CHANGE(transferProperty_u8) &&
           (Com_GetRamValue(TXSIGGRP,_TRIGONCHNG,txSigGrpConstPtr_pcst->sigGrpRAM_pst->txSigGrpRAMFields_u8)))
        {
            ...
            * changes
            */
            Com_SetRamValue(TXSIGGRP,_TRIGONCHNG,txSigGrpConstPtr_pcst->sigGrpRAM_pst->txSigGrpRAMFields_u8,COM_FALSE);
        }
