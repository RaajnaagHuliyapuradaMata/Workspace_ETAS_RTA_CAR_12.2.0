 ...
 **********************************************************************************************************************
*/
#ifndef BSWM_PRV_PROCESSDELAYEDREQST_H
#define BSWM_PRV_PROCESSDELAYEDREQST_H
...
BswM_ReqProcessing_ten BswM_Prv_GetComMInitiateResetInfo_en(uint16 idxERPChnl_u16, uint16 dataEventMode_u16, uint16 * nrRules_pu16, const uint16 * *adrRules_pu16);
#endif
...
BswM_ReqProcessing_ten BswM_Prv_GetDcmAppUpdateIndicationInfo_en(uint16 idxERPChnl_u16, uint16 dataEventMode_u16, uint16 * nrRules_pu16, const uint16 * *adrRules_pu16);
#endif
...
BswM_ReqProcessing_ten BswM_Prv_GetNmWkupIndInfo_en(uint16 idxERPChnl_u16, uint16 dataEventMode_u16, uint16 * nrRules_pu16, const uint16 * *adrRules_pu16);
#endif

#if (defined(BSWM_NO_OF_MRP_NM_STATE_CHG_NTF) && (BSWM_NO_OF_MRP_NM_STATE_CHG_NTF > 0 ))
BswM_ReqProcessing_ten BswM_Prv_GetNmStateChngNtfInfo_en(uint16 idxMRPChnl_u16, uint16 dataEventMode_u16, uint16 * nrRules_pu16, const uint16 * *adrRules_pu16);
#endif
...
BswM_ReqProcessing_ten BswM_Prv_SoAdSoConModeChgInfo_en(uint16 idxMRPChnl_u16, uint16 dataReqMode_u16, uint16 * nrRules_pu16, const uint16 * *adrRules_pu16);
#endif
