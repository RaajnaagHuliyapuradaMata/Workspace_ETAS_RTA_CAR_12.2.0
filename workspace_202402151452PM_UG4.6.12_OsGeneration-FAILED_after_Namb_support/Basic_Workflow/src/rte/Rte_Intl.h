...
#include "Rte_MemMap.h"
extern FUNC(boolean, RTE_CODE) Rte_MSITest(Rte_MSICounterType         count,
...
extern FUNC(void, RTE_CODE) Rte_WriteQueue_GetProtection(Rte_QCmnRefType q);
extern FUNC(void, RTE_CODE) Rte_WriteQueue_ReleaseProtection(Rte_QCmnRefType q);
#define RTE_EXT_STOP_SEC_CODE
#include "Rte_MemMap.h"
