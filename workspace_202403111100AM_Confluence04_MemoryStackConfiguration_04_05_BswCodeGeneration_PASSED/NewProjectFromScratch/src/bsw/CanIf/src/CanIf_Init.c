...
void CanIf_Init(const CanIf_ConfigType * ConfigPtr)
{
    ...
    {
        /* Update the DeviceMode to CAN_CS_STOPPED([SWS_CANIF_00476], [SWS_CANIF_00298]) &
         * Pdu Mode to CANIF_OFFLINE of each Controller */

        (controllerState_pst + index_u32)->Ctrl_Pdu_mode = (((uint8)CAN_CS_STOPPED)<<CANIF_Ctrl_BIT_SHIFT)|((uint8)CANIF_OFFLINE);
