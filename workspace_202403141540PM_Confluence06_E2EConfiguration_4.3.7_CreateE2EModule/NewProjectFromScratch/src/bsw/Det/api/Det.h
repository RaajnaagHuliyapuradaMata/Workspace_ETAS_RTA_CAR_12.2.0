 ...
 */
/*MR12 RULE 8.5 VIOLATION: Duplicate of Det_ReportError to make it also available in the GeneralDiagnosticInfo RTE interface */
 ...
 * @return                  returns always E_OK (is required for services).
 */
/*MR12 RULE 8.5 VIOLATION: Duplicate of Det_ReportRuntimeError to make it also available in the GeneralDiagnosticInfo RTE interface */
 ...
 */
/*MR12 RULE 8.5 VIOLATION: Duplicate of  Det_ReportTransientFault to make it also available in the GeneralDiagnosticInfo RTE interface */
