...
#if !defined(COM_PBCFG_INTERNAL_SYMBOLIC_NAMES_H)
#define COM_PBCFG_INTERNAL_SYMBOLIC_NAMES_H
 ...
 *
 * Below generated macro COM_PBCFG_INCLUDE_INT_SYM_NAMES"variantExtension" has to be defined in variant specific 
 * Com_PBcfg.c source file to enable internal symbolic names specific for that variant
 */

# ifdef COM_PBCFG_INCLUDE_INT_SYM_NAMES


/* ------------------------------------------------------------------------ */
/* Begin section for Tx IPdu internal symbolic names */

#  define   ComIPdu_Internal_IP_ApplicationECU_To_TestECU_Can_Network_Channel_CAN_Tx               0
...
#  define   ComIPdu_Internal_IP_TestECU_To_ApplicationECU_Can_Network_Channel_CAN_Rx               0
...
#  define   ComSignal_Internal_S_ApplicationECU_To_TestECU_Data_Can_Network_Channel_CAN_Tx               0
...
#  define   ComSignal_Internal_S_TestECU_To_ApplicationECU_Data_Can_Network_Channel_CAN_Rx               0
...
# endif /* end of COM_PBCFG_INCLUDE_INT_SYM_NAMES */

#endif /* end of COM_PBCFG_INTERNAL_SYMBOLIC_NAMES_H */
